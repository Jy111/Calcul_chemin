...
public class GraphTest {
    ...
    public Graph allCities(){
        return new Graph(lille, paris, lemans, reims, marseille, lyon, clermont, montpellier, nantes, bordeaux, toulouse, nancy);
    }
    ...
    @Test
    public void getDistanceWithoutEdgesInGraph(){
        Graph graph5 = new Graph(paris, bordeaux, toulouse);
        assertEquals(graph5.getDistance("Paris", "Toulouse"),0);
    }

    @Test
    public void getDistanceWithoutVertexInGraph(){
        Graph graph5 = new Graph();
        assertEquals(graph5.getDistance("Paris", "Clermont Ferrant"), 0);
    }

    @Test
    public void getDistanceWithNoExistVertex(){
        assertEquals(allCities().getDistance("Marseille", "Fleurbaix"),0);
    }

    @Test
    public void getDistanceWithoutPossiblesPaths(){
        assertEquals(allCities().getDistance("Bordeaux", "Le Mans"),0);
    }
